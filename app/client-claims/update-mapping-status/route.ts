...
import { processClientClaimMappingStatusSubmission } from "@/lib/review/client-claims-page";
...
export async function POST(request: Request) {
  ...
  const submission = await processClientClaimMappingStatusSubmission(formData, auth);
