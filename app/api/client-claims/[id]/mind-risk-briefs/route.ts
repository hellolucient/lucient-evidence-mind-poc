...
import { buildListMindRiskBriefsApiResponse } from "@/lib/review/mind-risk-brief-jobs-api";
...
export async function GET(request: NextRequest, context: RouteContext) {
  ...
  const route = `/api/client-claims/${id}/mind-risk-briefs`;
  ...
  const response = await buildListMindRiskBriefsApiResponse(id, auth);
