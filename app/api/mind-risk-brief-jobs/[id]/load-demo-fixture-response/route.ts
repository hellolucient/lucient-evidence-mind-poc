...
import {
  buildLoadMindRiskBriefDemoFixtureResponseApiResponse,
...
export async function POST(request: NextRequest, context: RouteContext) {
  ...
  const route = `${mindRiskBriefJobsApiRoute(id)}/load-demo-fixture-response`;
  ...
  const response = await buildLoadMindRiskBriefDemoFixtureResponseApiResponse(
    id,
