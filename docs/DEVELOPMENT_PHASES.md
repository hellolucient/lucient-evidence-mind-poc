...
> **For current phase status (Phases 21–35), see [evidence-mind-roadmap.md](./evidence-mind-roadmap.md) — the canonical live roadmap.** Production phase marker: **35**. Next proposed: **Phase 36 — Watchtower Narrative History / Diff Layer**. This file provides historical detail for Phases 1–20 and a concise summary for Phases 21–28. When there is a conflict, the roadmap wins.
...
**Next (historical note):** Phase 28+ built on these mappings for evidence briefs and downstream Mind digest/narrative flows. See [evidence-mind-roadmap.md](./evidence-mind-roadmap.md) for current status (Phase 35 validated).
...
| **Phases 28–35** | Evidence briefs, Mind digests, handoffs, test-sink send, send audit, operator approval, watchtower narratives — see [evidence-mind-roadmap.md](./evidence-mind-roadmap.md) |
| **Phase 36** | Watchtower narrative history / diff layer (planned — next) |
